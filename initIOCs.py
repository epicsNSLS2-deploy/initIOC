...
def read_ioc_config(initial_ioc_number):
    ...
    if not os.path.exists("CONFIGURE"):
        initIOC_print('CONFIGURE file not found, attempting to generate one.')
        try:
            config_fp = open("CONFIGURE", "w")
            config_fp.write('#\n# initIOCs CONFIGURE file autogenerated on {}\n#\n\n'.format(datetime.datetime.now()))
            for elem in base_configuration.keys():
                config_fp.write('# {}\n'.format(config_tooltips[elem]))
                config_fp.write('{}={}\n\n'.format(elem, base_configuration[elem]))

            config_fp.write('# IOC Type        IOC Name     Asyn Port      IOC Port      Cam Connection\n')
            config_fp.write('#-------------------------------------------------------------------------\n')
            config_fp.close()
        except PermissionError:
